...
<head>
    ...
    <title>Yönetim - Gönderi Ekle</title>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Gönderi Ekle</h6>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="/panel/gonderiler/ekle">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="postTitle">Gönderi Başlığı</label>
                                    <input type="text" class="form-control" name="postTitle" id="postTitle" placeholder="Gönderi Başlığı" required>
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="postContent">Gönderi İçeriği</label>
                                    <textarea class="form-group" name="postContent" id="postContent"></textarea>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="postTags">Etiketler</label>
                                    <input type="text" class="form-control" name="postTags" id="postTags" placeholder="Etiketler" required>
...
</html><?php /**PATH C:\xampp\htdocs\public\views/dashboard/postAdd.blade.php ENDPATH**/ ?>