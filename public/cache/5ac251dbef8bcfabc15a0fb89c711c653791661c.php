...
<head>
    ...
    <title>Yönetim - Kategori Düzenle</title>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/panel/kategoriler/duzenle">
                            <input type="hidden" name="id" value="<?php echo e($categoryDetails["id"]); ?>">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="categoryTitle">Kategori Başlığı</label>
                                    <input type="text" class="form-control" name="categoryTitle" id="categoryTitle" placeholder="Kategori Başlığı" value="<?php echo e($categoryDetails["categoryName"]); ?>" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="categoryAuthor">Kategoriyi Oluşturan</label>
                                    <input type="text" class="form-control" name="categoryAuthor" id="categoryAuthor" placeholder="Kategoriyi Oluşturan" value="<?php echo e($categoryDetails["name"]); ?>" disabled>
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="categoryDesc">Gönderi İçeriği</label>
                                    <textarea class="form-control" name="categoryDesc" id="categoryDesc" required><?php echo e($categoryDetails["categoryDesc"]); ?></textarea>
                                </div>
...
</html><?php /**PATH C:\xampp\htdocs\public\views/dashboard/editCategory.blade.php ENDPATH**/ ?>