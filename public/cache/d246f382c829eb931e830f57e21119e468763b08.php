        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="site-heading">
                    <h1>Kategoriler</h1>
                    <span class="subheading">Tüm kategoriler</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-10 col-lg-8 col-xl-7">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="post-preview">
                    <a href="/kategori/<?php echo e(permalink($category["categoryName"])); ?>-<?php echo e($category["id"]); ?>">
                        <h2 class="post-title"><?php echo e($category["categoryName"]); ?></h2>
                    </a>
                </div>
                <hr class="my-4" />
...
<?php /**PATH C:\xampp\htdocs\public\views/categories.blade.php ENDPATH**/ ?>