                        ...
                        <form method="POST" action="/panel/kategoriler/duzenle">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="categoryTitle" id="categoryTitle" placeholder="Kategori Başlığı" value="{{ $categoryDetails["categoryName"] }}" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="categoryAuthor">Kategoriyi Oluşturan</label>
                                    <input type="text" class="form-control" name="categoryAuthor" id="categoryAuthor" placeholder="Kategoriyi Oluşturan" value="{{ $categoryDetails["name"] }}" disabled>
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="categoryDesc">Gönderi İçeriği</label>
                                    <textarea class="form-control" name="categoryDesc" id="categoryDesc" required>{{ $categoryDetails["categoryDesc"] }}</textarea>
                                </div>
