                        ...
                        <form method="POST" action="/panel/gonderiler/duzenle">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="postTitle" id="postTitle" placeholder="Gönderi Başlığı" value="{{ $postDetails["postTitle"] }}" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="postAuthor">Yazar</label>
                                    <input type="text" class="form-control" name="postAuthor" id="postAuthor" placeholder="Yazar" value="{{ $postDetails["name"] }}" disabled>
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="postContent">Gönderi İçeriği</label>
                                    <textarea class="form-group" name="postContent" id="postContent" required>{!! $postDetails["postContent"] !!}</textarea>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="postTags">Etiketler</label>
                                    <input type="text" class="form-control" name="postTags" id="postTags" placeholder="Etiketler" value="{{ $postDetails["postTags"] }}" required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="postCategory" name="postCategory">
                                        @foreach($categories as $category)
                                            <option value="{{ $category["id"] }}" {{ $category["id"] == $postDetails["id"] ? "selected" : "" }}>{{ $category["categoryName"] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
