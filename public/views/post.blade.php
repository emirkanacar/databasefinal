            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="post-heading">
                    ...
                    <span class="meta">
                        ...
                        Tarafından Yazıldı |
                        {{ timeAgo($post["created_at"]) }} | Kategori:
                        <a href="/kategori/{{ permalink($post["categoryDetails"]["categoryName"]) }}-{{ $post["categoryDetails"]["id"] }}">{{ $post["categoryDetails"]["categoryName"] }}</a>
                    </span>
                </div>
            </div>
        </div>
